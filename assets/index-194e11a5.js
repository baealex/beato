var Hs=Object.defineProperty;var Ws=(t,e,n)=>e in t?Hs(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var F=(t,e,n)=>(Ws(t,typeof e!="symbol"?e+"":e,n),n);import{r as m,a as Vs,c as B,b as Jn,_ as Ks,u as Z,d as Js,L as Pr,e as He,O as Ys,f as pn,g as mn,h as Gs,Q as Xs,i as Qs,j as Zs,k as ei,R as ti}from"./vendor-fa7a2e94.js";import{u as ni,a as Yn,D as ri,r as si,b as ii,c as oi,S as ai,v as ci,s as li,K as di,P as ui,d as gn,C as yn,e as bn}from"./sortable-b0dcf770.js";import{m as xn}from"./motion-e6209d02.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();var Mr={exports:{}},gt={};/**
 * @license React
...
`;function _n({images:t,className:e}){const n=t.length>=16?4:t.length>=9?3:t.length>=4?2:1;return a.jsxs(Oo,{className:`${e} col-${n}`,children:[t.length===0&&a.jsx(he,{}),t.slice(0,n*n).map((r,s)=>a.jsx(he,{src:r,alt:""},s))]})}var fe={},vt={},Sn={};Object.defineProperty(Sn,"__esModule",{value:!0});Sn.default={COLOR_WHITE:"#ffffff",COLOR_BLACK:"#000000",COLOR_PURPLE_DEEP:"#474787",COLOR_PURPLE_SHALLOW:"#515199",COLOR_PURPLE_NEON:"#735af2",COLOR_PURPLE_PROMINENT:"#a076f1",COLOR_PURPLE_LIVE:"#9b59b6",COLOR_PURPLE_GRAPE:"#8e44ad",COLOR_PURPLE_VIVID:"#5800ff",COLOR_PURPLE_GRAY:"#eeeeff",COLOR_EMBER:"#ffdd00",COLOR_YELLOW:"#f7cb46",COLOR_YELLOW_GRAY:"#e7e6e7"};var jn={};Object.defineProperty(jn,"__esModule",{value:!0});jn.default={CARD_SHADOW_MAIN:"0 6px 24px 1px rgba(0, 0, 0, 0.1)",CARD_SHADOW_SUB:"0 0 10px rgba(0, 0, 0, 0.1)",SHADOW_NEON_PURPLE:"0 16px 16px rgba(115, 90, 242, .3)"};var pt=B&&B.__assign||function(){return pt=Object.assign||function(t){for(var e,n=1,r=arguments.length;n<r;n++){e=arguments[n];for(var s in e)Object.prototype.hasOwnProperty.call(e,s)&&(t[s]=e[s])}return t},pt.apply(this,arguments)};Object.defineProperty(vt,"__esModule",{value:!0});var Ro=Sn,No=jn;vt.default=pt(pt({},Ro.default),No.default);var An={};Object.defineProperty(An,"__esModule",{value:!0});var Le=vt,To="box-shadow: ".concat(Le.default.CARD_SHADOW_MAIN,";"),Lo="box-shadow: ".concat(Le.default.CARD_SHADOW_SUB,";"),Po=["color: ".concat(Le.default.COLOR_WHITE,";"),"box-shadow: ".concat(Le.default.SHADOW_NEON_PURPLE,";"),"background-color: ".concat(Le.default.COLOR_PURPLE_NEON,";")].join(`
`);An.default={CARD_SHADOW_MAIN:To,CARD_SHADOW_SUB:Lo,NEON_PURPLE_BUTTON:Po};(function(t){Object.defineProperty(t,"__esModule",{value:!0}),t.mixin=t.theme=void 0;var e=vt;Object.defineProperty(t,"theme",{enumerable:!0,get:function(){return e.default}});var n=An;Object.defineProperty(t,"mixin",{enumerable:!0,get:function(){return n.default}})})(fe);const Mo=S.div`
    flex: 1;
    display: flex;
...
`;function $s({active:t,label:e,onClick:n,onSelectAll:r}){return a.jsxs(a.Fragment,{children:[a.jsxs(Tr,{className:`clickable ${t?"active":""}`,onClick:n,children:[a.jsx(On,{}),e]}),t&&a.jsxs(Tr,{className:"clickable",onClick:r,children:[a.jsx(Io,{}),"Select All"]})]})}const hl=S.div`
    .panel-content {
        display: flex;
        flex-direction: column;
        gap: 1.5rem;
...
`;function zl({playlist:t,onClick:e,onLongPress:n}){const{attributes:r,listeners:s,setNodeRef:i,transform:o,transition:l}=gn({id:t.id}),d={transform:yn.Transform.toString(o),transition:l};return a.jsxs(Fl,{ref:i,style:d,...r,children:[a.jsx("div",{className:"icon-button",...s,style:{cursor:"grab",touchAction:"none"},children:a.jsx(kt,{})}),a.jsx("div",{style:{flex:1,maxWidth:"calc(100% - 4rem)"},children:a.jsx(qs,{...t,onClick:e,onLongPress:n},t.id)})]})}function Hl(){const t=Z(),[{playlists:e,loaded:n},r]=R(Wn),s=async()=>{const o=await D.prompt("Enter playlist name");ie.create(o)},i=o=>{const{active:l,over:d}=o;if(d&&l.id!==d.id){const u=e.findIndex(y=>y.id===l.id),c=e.findIndex(y=>y.id===d.id),h=bn(e,u,c);ie.changeOrder(h.map(y=>y.id)),r(y=>({...y,playlists:h}))}};return a.jsxs(a.Fragment,{children:[a.jsxs(je,{children:[a.jsx("div",{}),a.jsx(q,{onClick:s,children:"New Playlist"})]}),a.jsxs(Kn,{items:e.map(o=>o.id),onDragEnd:i,children:[!n&&a.jsx(Ee,{}),n&&(e==null?void 0:e.map(o=>a.jsx(zl,{playlist:o,onClick:()=>t(`/playlist/${o.id}`),onLongPress:()=>L.open({content:a.jsx(ml,{id:o.id,onPlaylistClick:()=>t(`/playlist/${o.id}`)})})},o.id)))]})]})}const Wl=S.div`
    display: flex;
    flex-direction: row;
    align-items: center;
...
`;function Kl({music:t,isSelectMode:e,isSelected:n,onClick:r,onSelect:s,onLongPress:i}){const{attributes:o,listeners:l,setNodeRef:d,transform:u,transition:c}=gn({id:t.id}),h={transform:yn.Transform.toString(u),transition:c};return a.jsxs(Wl,{ref:d,style:h,...o,children:[e?a.jsx("button",{className:`icon-button checkbox ${n?"active":""} `,onClick:s,children:a.jsx(On,{})}):a.jsx("div",{className:"icon-button checkbox",...l,style:{cursor:"grab",touchAction:"none"},children:a.jsx(kt,{})}),a.jsx("div",{style:{flex:1,maxWidth:"calc(100% - 4rem)"},children:a.jsx(be,{albumName:t.album.name,albumCover:t.album.cover,artistName:t.artist.name,musicName:t.name,musicCodec:t.codec,isLiked:t.isLiked,onClick:e?s:r,onLongPress:i})})]})}function Jl(){const t=Z(),{id:e}=pn(),n=Gs(),{data:r}=mn(["playlist",e],()=>rl(e).then(c=>c.data.playlist),{enabled:!!e}),[{musicMap:s}]=R(z),[i,o]=m.useState(!1),[l,d]=m.useState([]),u=c=>{const{active:h,over:y}=c;if(r&&y&&h.id!==y.id){const x=r.musics.findIndex(({id:w})=>w===h.id),p=r.musics.findIndex(({id:w})=>w===y.id),g=bn(r.musics,x,p);ie.changeMusicOrder(r.id,g.map(({id:w})=>w)),n.setQueryData(["playlist",e],()=>({...r,musics:g}))}};return m.useEffect(()=>{const c=()=>{n.invalidateQueries(["playlist",e])};return b.on(Me,c),b.on(Be,c),b.on(Ie,c),()=>{b.off(Me,c),b.off(Be,c),b.off(Ie,c)}},[e,n]),m.useEffect(()=>{d([])},[i]),r?a.jsxs(Vl,{children:[a.jsxs("div",{className:"header",children:[a.jsx(_n,{className:"cover",images:r.musics.slice(0,16).map(c=>{var h;return((h=s.get(c.id))==null?void 0:h.album.cover)??""})}),a.jsx("h1",{children:r.name})]}),a.jsxs(je,{children:[a.jsx("div",{style:{display:"flex",alignItems:"center",gap:"1rem"},children:a.jsx($s,{active:i,label:i?`${l.length} selected`:`${r.musics.length} musics`,onClick:()=>o(!i),onSelectAll:()=>d(r.musics.map(({id:c})=>c))})}),a.jsxs(q,{onClick:()=>v.reset(r.musics.map(({id:c})=>c)),children:[a.jsx(J,{})," Play"]})]}),a.jsx("div",{style:{flex:1},children:a.jsx(Kn,{items:r.musics.map(({id:c})=>c),onDragEnd:u,children:r.musics.map(({id:c})=>{const h=s.get(c);return h?a.jsx(Kl,{music:h,isSelectMode:i,isSelected:l.includes(h.id),onClick:()=>v.add(h.id),onSelect:()=>{l.includes(h.id)?d(l.filter(y=>y!==h.id)):d([...l,h.id])},onLongPress:()=>L.open({content:a.jsx(ye,{id:h.id,onAlbumClick:()=>t(`/album/${h.album.id}`),onArtistClick:()=>t(`/artist/${h.artist.id}`)})})},h.id):null})})}),i&&l.length>0&&a.jsxs("div",{className:"select-actions",children:[a.jsxs("button",{className:"clickable",onClick:()=>{l.forEach(c=>v.add(c)),o(!1)},children:[a.jsx(J,{}),a.jsx("span",{children:"Play"})]}),a.jsxs("button",{className:"clickable",onClick:()=>L.open({title:"Move to playlist",content:a.jsx(Vn,{onClick:c=>{ie.moveMusic(r.id,c,l),D.toast("Moved to playlist"),o(!1)}})}),children:[a.jsx(Rn,{}),a.jsx("span",{children:"Move"})]}),a.jsxs("button",{className:"clickable",onClick:async()=>{ie.removeMusic(r.id,l),o(!1)},children:[a.jsx(Nn,{}),a.jsx("span",{children:"Delete"})]})]})]}):null}const Yl=S.div`
    display: flex;
    flex-direction: column;
    height: 100%;
