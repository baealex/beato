...
`;function Jr({albumCover:t,albumName:e,artistName:n,onClick:r}){return a.jsxs(Eo,{onClick:r,children:[a.jsx(he,{className:"cover",src:t,alt:e}),a.jsx("span",{className:"title",children:e}),a.jsx("span",{className:"artist",children:n})]})}const _o=A.button`
    cursor: pointer;
    padding: 1rem;
    display: flex;
    flex-direction: row;
...
`;function $s({active:t,label:e,onClick:n,onSelectAll:r}){return a.jsxs(a.Fragment,{children:[a.jsxs(Lr,{className:`clickable ${t?"active":""}`,onClick:n,children:[a.jsx(An,{}),e]}),t&&a.jsxs(Lr,{className:"clickable",onClick:r,children:[a.jsx(Io,{}),"Select All"]})]})}const hl=A.div`
    .panel-content {
        display: flex;
        flex-direction: column;
        gap: 1.5rem;
...
`,Kt=100;function Sl(){const t=Z(),[e,n]=We(),[{albums:r,loaded:s}]=R(Us),[i,o]=m.useState(Number(e.get("l"))||Kt),l=async()=>{const c=await $.prompt("Search keyword",e.get("q")||"");n({q:c})},d=()=>{o(i+Kt),e.set("l",(i+Kt).toString()),n(e,{replace:!0})},u=r==null?void 0:r.filter(c=>{var h,y;return c.name.toLowerCase().includes(((h=e.get("q"))==null?void 0:h.toLowerCase())||"")||c.artist.name.toLowerCase().includes(((y=e.get("q"))==null?void 0:y.toLowerCase())||"")});return a.jsxs(a.Fragment,{children:[a.jsx(je,{children:a.jsx(U,{style:{width:"160px"},onClick:l,children:e.get("q")||"Search"})}),!s&&a.jsx(Ee,{}),a.jsx(_l,{children:s&&u.slice(0,i).map(c=>a.jsx(Jr,{albumName:c.name,albumCover:c.cover,artistName:c.artist.name,onClick:()=>t(`/album/${c.id}`)},c.id))}),s&&u.length>i&&a.jsx("div",{style:{padding:"0 16px 16px"},children:a.jsx(U,{style:{width:"100%",justifyContent:"center"},onClick:d,children:"Load More"})})]})}const jl=A.div`
    position: relative;
    display: flex;
    flex-direction: column;
    align-items: center;
...
`,Al=A.ul`
    ...
    padding: 0;
    list-style: none;
`;function Ol(){const t=Z(),{id:e}=fn(),{data:n}=pn(["album",e],()=>tl(e).then(s=>s.data.album),{enabled:!!e}),[{musicMap:r}]=R(z);return n?a.jsxs(a.Fragment,{children:[a.jsxs(jl,{children:[a.jsx(he,{className:"album-cover",src:n.cover.replace("/resized","")||"",alt:n==null?void 0:n.name}),a.jsx("div",{className:"album-title",children:n==null?void 0:n.name}),a.jsxs("div",{className:"row",children:[a.jsx(Pr,{className:"album-artist",to:`/artist/${n==null?void 0:n.artist.id}`,children:n==null?void 0:n.artist.name}),"-",a.jsx("span",{className:"album-year",children:n==null?void 0:n.publishedYear})]}),a.jsx("div",{className:"play-all",children:a.jsx("button",{onClick:()=>v.reset(n.musics.map(s=>s.id)),children:a.jsx(J,{})})})]}),a.jsx(Al,{children:n.musics.map(({id:s})=>{const i=r.get(s);return i?a.jsx(be,{albumName:i.album.name,artistName:i.artist.name,trackNumber:i.trackNumber,musicName:i.name,musicCodec:i.codec,isLiked:i.isLiked,onClick:()=>v.add(i.id),onLongPress:()=>T.open({title:"Related to this music",content:a.jsx(ye,{id:i.id,onArtistClick:()=>t(`/artist/${i.artist.id}`)})})},i.id):null})})]}):null}class Rl extends pe{constructor(){super();F(this,"init",!1);this.state={loaded:!1,artists:[]}}get state(){return this.init||(this.init=!0,this.sync()),super.state}set state(n){super.state=n}async sync(){Qc().then(({data:n})=>{this.set({loaded:!0,artists:n.allArtists})})}}const Fs=new Rl,Jt=150;function Nl(){const t=Z(),[e,n]=We(),[{artists:r,loaded:s}]=R(Fs),[i,o]=m.useState(Number(e.get("l"))||Jt),l=()=>{o(i+Jt),e.set("l",(i+Jt).toString()),n(e,{replace:!0})},d=async()=>{const c=await $.prompt("Search keyword",e.get("q")||"");n({q:c})},u=r==null?void 0:r.filter(c=>{var h;return c.name.toLowerCase().includes(((h=e.get("q"))==null?void 0:h.toLowerCase())||"")});return a.jsxs(a.Fragment,{children:[a.jsx(je,{children:a.jsx(U,{style:{width:"160px"},onClick:d,children:e.get("q")||"Search"})}),!s&&a.jsx(Ee,{}),s&&u.slice(0,i).map(c=>{var h;return a.jsx(So,{artistName:c.name,artistCover:((h=c.latestAlbum)==null?void 0:h.cover)||"",musicCount:c.musicCount,albumCount:c.albumCount,onClick:()=>t(`/artist/${c.id}`)},c.id)}),s&&u.length>i&&a.jsx("div",{style:{padding:"0 16px 16px"},children:a.jsx(U,{style:{width:"100%",justifyContent:"center"},onClick:l,children:"Load More"})})]})}const Ll=A.section`
    .artist-name {
        display: flex;
        flex-direction: column;
        align-items: center;
...
`;function Tl(){var i;const t=Z(),{id:e}=fn(),{data:n}=pn(["artist",e],()=>Zc(e).then(o=>o.data.artist),{enabled:!!e}),[{musicMap:r}]=R(z);if(!n)return null;const s=n.musics.reduce((o,{id:l})=>{var d;return o+=((d=r.get(l))==null?void 0:d.playCount)||0},0);return a.jsxs(Ll,{children:[a.jsxs("div",{className:"artist-name",children:[a.jsx("div",{className:"cover",children:a.jsx("div",{children:a.jsx(he,{src:((i=n.latestAlbum)==null?void 0:i.cover)||"",alt:n.name})})}),n.name,a.jsxs("span",{className:"detail-info",children:["You have listened to a song by this artist ",s," times."]})]}),a.jsxs("div",{className:"section-title",children:["Albums (",n.albums.length,")"]}),a.jsx("div",{className:"albums",children:n.albums.map(o=>a.jsx(Jr,{albumCover:o.cover,albumName:o.name,artistName:o.publishedYear,onClick:()=>t(`/album/${o.id}`)},o.id))}),a.jsxs("div",{className:"section-title",children:["Songs (",n.musics.length,")",a.jsxs(U,{onClick:()=>v.reset(n.musics.map(o=>o.id)),children:[a.jsx(J,{})," Play"]})]}),a.jsx("div",{className:"musics",children:n.musics.map(({id:o})=>{const l=r.get(o);return l?a.jsx(be,{artistName:l.album.name,albumCover:l.album.cover,albumName:l.album.name,musicName:l.name,musicCodec:l.codec,isLiked:l.isLiked,onClick:()=>v.add(l.id),onLongPress:()=>T.open({title:"Related to this music",content:a.jsx(ye,{id:l.id,onAlbumClick:()=>t(`/album/${l.album.id}`)})})},l.id):null})})]})}const Yt=200;function Pl(){const t=Z(),[e,n]=We(),[{musics:r,loaded:s}]=R(z),[i,o]=m.useState(Number(e.get("l"))||Yt),l=async()=>{const c=await $.prompt("Search keyword",e.get("q")||"");n({q:c})},d=()=>{o(i+Yt),e.set("l",(i+Yt).toString()),n(e,{replace:!0})},u=r==null?void 0:r.filter(c=>{var h,y,x;return c.isLiked&&(c.name.toLowerCase().includes(((h=e.get("q"))==null?void 0:h.toLowerCase())||"")||c.artist.name.toLowerCase().includes(((y=e.get("q"))==null?void 0:y.toLowerCase())||"")||c.album.name.toLowerCase().includes(((x=e.get("q"))==null?void 0:x.toLowerCase())||""))});return a.jsxs(a.Fragment,{children:[a.jsxs(je,{children:[a.jsx(U,{style:{width:"160px"},onClick:l,children:e.get("q")||"Search"}),a.jsxs(U,{onClick:()=>v.reset(u.map(c=>c.id)),children:[a.jsx(J,{})," Play"]})]}),!s&&a.jsx(Ee,{}),s&&u.slice(0,i).map(c=>a.jsx(be,{albumName:c.album.name,albumCover:c.album.cover,artistName:c.artist.name,musicName:c.name,musicCodec:c.codec,isLiked:c.isLiked,onClick:()=>v.add(c.id),onLongPress:()=>T.open({title:"Related to this music",content:a.jsx(ye,{id:c.id,onAlbumClick:()=>t(`/album/${c.album.id}`),onArtistClick:()=>t(`/artist/${c.artist.id}`)})})},c.id)),s&&u.length>i&&a.jsx("div",{style:{padding:"0 16px 16px"},children:a.jsx(U,{style:{width:"100%",justifyContent:"center"},onClick:d,children:"Load More"})})]})}const Xt=200;function Ml(){const t=Z(),[e,n]=We(),[{musics:r,loaded:s}]=R(z),[i,o]=m.useState(Number(e.get("l"))||Xt),l=async()=>{const c=await $.prompt("Search keyword",e.get("q")||"");e.set("q",c),n(e,{replace:!0})},d=()=>{o(i+Xt),e.set("l",(i+Xt).toString()),n(e,{replace:!0})},u=r==null?void 0:r.filter(c=>{var h,y,x;return c.name.toLowerCase().includes(((h=e.get("q"))==null?void 0:h.toLowerCase())||"")||c.artist.name.toLowerCase().includes(((y=e.get("q"))==null?void 0:y.toLowerCase())||"")||c.album.name.toLowerCase().includes(((x=e.get("q"))==null?void 0:x.toLowerCase())||"")});return a.jsxs(a.Fragment,{children:[a.jsxs(je,{children:[a.jsx(U,{style:{width:"160px"},onClick:l,children:e.get("q")||"Search"}),a.jsxs(U,{onClick:()=>v.reset(u.map(c=>c.id)),children:[a.jsx(J,{})," Play"]})]}),!s&&a.jsx(Ee,{}),s&&u.slice(0,i).map(c=>a.jsx(be,{albumName:c.album.name,albumCover:c.album.cover,artistName:c.artist.name,musicName:c.name,musicCodec:c.codec,isLiked:c.isLiked,onClick:()=>v.add(c.id),onLongPress:()=>T.open({title:"Related to this music",content:a.jsx(ye,{id:c.id,onAlbumClick:()=>t(`/album/${c.album.id}`),onArtistClick:()=>t(`/artist/${c.artist.id}`)})})},c.id)),s&&u.length>i&&a.jsx("div",{style:{padding:"0 16px 16px"},children:a.jsx(U,{style:{width:"100%",justifyContent:"center"},onClick:d,children:"Load More"})})]})}const Bl=A.div`
    height: 100%;
    display: flex;
    flex-direction: column;
    justify-content: center;
...
`;function zl({music:t,isSelectMode:e,isSelected:n,onClick:r,onSelect:s,onLongPress:i}){const{attributes:o,listeners:l,setNodeRef:d,transform:u,transition:c}=mn({id:t.id}),h={transform:gn.Transform.toString(u),transition:c};return a.jsxs(Ul,{ref:d,style:h,...o,children:[e?a.jsx("button",{className:`icon-button checkbox ${n?"active":""} `,onClick:s,children:a.jsx(An,{})}):a.jsx("div",{className:"icon-button checkbox",...l,style:{cursor:"grab",touchAction:"none"},children:a.jsx(Et,{})}),a.jsx("div",{style:{flex:1,maxWidth:"calc(100% - 4rem)"},children:a.jsx(be,{albumName:t.album.name,albumCover:t.album.cover,artistName:t.artist.name,musicName:t.name,musicCodec:t.codec,isLiked:t.isLiked,onClick:e?s:r,onLongPress:i})})]})}function Hl(){const t=Z(),{id:e}=fn(),n=Xs(),{data:r}=pn(["playlist",e],()=>rl(e).then(c=>c.data.playlist),{enabled:!!e}),[{musicMap:s}]=R(z),[i,o]=m.useState(!1),[l,d]=m.useState([]),u=c=>{const{active:h,over:y}=c;if(r&&y&&h.id!==y.id){const x=r.musics.findIndex(({id:w})=>w===h.id),p=r.musics.findIndex(({id:w})=>w===y.id),g=yn(r.musics,x,p);ie.changeMusicOrder(r.id,g.map(({id:w})=>w)),n.setQueryData(["playlist",e],()=>({...r,musics:g}))}};return m.useEffect(()=>{const c=()=>{n.invalidateQueries(["playlist",e])};return b.on(Be,c),b.on(Ie,c),b.on(De,c),()=>{b.off(Be,c),b.off(Ie,c),b.off(De,c)}},[e,n]),m.useEffect(()=>{d([])},[i]),r?a.jsxs(Fl,{children:[a.jsxs("div",{className:"header",children:[a.jsx(En,{className:"cover",images:r.musics.slice(0,16).map(c=>{var h;return((h=s.get(c.id))==null?void 0:h.album.cover)??""})}),a.jsx("h1",{children:r.name})]}),a.jsxs(je,{children:[a.jsx("div",{style:{display:"flex",alignItems:"center",gap:"1rem"},children:a.jsx($s,{active:i,label:i?`${l.length} selected`:`${r.musics.length} musics`,onClick:()=>o(!i),onSelectAll:()=>d(r.musics.map(({id:c})=>c))})}),a.jsxs(U,{onClick:()=>v.reset(r.musics.map(({id:c})=>c)),children:[a.jsx(J,{})," Play"]})]}),a.jsx("div",{style:{flex:1},children:a.jsx(Kn,{items:r.musics.map(({id:c})=>c),onDragEnd:u,children:r.musics.map(({id:c})=>{const h=s.get(c);return h?a.jsx(zl,{music:h,isSelectMode:i,isSelected:l.includes(h.id),onClick:()=>v.add(h.id),onSelect:()=>{l.includes(h.id)?d(l.filter(y=>y!==h.id)):d([...l,h.id])},onLongPress:()=>T.open({content:a.jsx(ye,{id:h.id,onAlbumClick:()=>t(`/album/${h.album.id}`),onArtistClick:()=>t(`/artist/${h.artist.id}`)})})},h.id):null})})}),i&&l.length>0&&a.jsxs("div",{className:"select-actions",children:[a.jsxs("button",{className:"clickable",onClick:()=>{l.forEach(c=>v.add(c)),o(!1)},children:[a.jsx(J,{}),a.jsx("span",{children:"Play"})]}),a.jsxs("button",{className:"clickable",onClick:async()=>{ie.removeMusic(r.id,l),o(!1)},children:[a.jsx(Rn,{}),a.jsx("span",{children:"Delete"})]}),a.jsxs("button",{className:"clickable",onClick:()=>T.open({title:"Move to playlist",content:a.jsx(Vn,{onClick:c=>{ie.moveMusic(r.id,c,l),$.toast("Moved to playlist"),o(!1)}})}),children:[a.jsx(On,{}),a.jsx("span",{children:"Move"})]})]})]}):null}const Wl=A.div`
    display: flex;
    flex-direction: column;
    height: 100%;
